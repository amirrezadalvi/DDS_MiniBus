/****************************************************************************
** Meta object code from reading C++ file 'transport_base.h'
**
...
#error "The header file 'transport_base.h' doesn't include <QObject>."
...
template <> constexpr inline auto ITransport::qt_create_metaobjectdata<qt_meta_tag_ZN10ITransportE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QByteArray &, QHostAddress, quint16)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void ITransport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->datagramReceived((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QHostAddress>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<quint16>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ITransport::*)(const QByteArray & , QHostAddress , quint16 )>(_a, &ITransport::datagramReceived, 0))
            return;
    }
}
...
// SIGNAL 0
void ITransport::datagramReceived(const QByteArray & _t1, QHostAddress _t2, quint16 _t3)
{
